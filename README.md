...
[PLAN](docs/PLAN.md) · [ROADMAP](docs/ROADMAP.md) · [BUSINESS](docs/BUSINESS.md) · [DESIGN](docs/DESIGN.md) · [design preview](docs/design/preview.html)

## What's built (Phase 1: identity)
...
- Admin panel: university requests, user search, suspend/ban/reinstate, with an audit log
- The Quad design system (`packages/ui`) implementing [DESIGN.md](docs/DESIGN.md)
